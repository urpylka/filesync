...
class Device(object):
    """
    1. Как описать общий механизм работы функции, если разные ее исполенения возвращают разный результат?
    ...
    5. Загрузка чанками requests https://stackoverflow.com/questions/13909900/progress-of-python-requests-post
